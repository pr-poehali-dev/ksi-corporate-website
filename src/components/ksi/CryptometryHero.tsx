      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="font-ibm text-white/50 text-lg leading-relaxed mb-10 max-w-2xl">
            КриптоМетры — ключевой проект АО КСИ, интеллектуальная система распределённого
            девелопмента. Единая среда, в которой задачи, компетенции, внутренние службы
            и прикладные контуры собираются в управляемую модель.
          </p>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="font-ibm text-white/50 text-lg leading-relaxed">
              КриптоМетры — не цифровой интерфейс и не набор разрозненных функций.
              Это интеллектуальная система распределённого девелопмента, которую развивает
              АО КСИ через собственные внутренние службы и прикладные контуры.
            </p>
          </div>
