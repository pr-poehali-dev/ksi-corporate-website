...
const WHAT_IS = [
  { icon: "Layers", text: "Ключевой цифровой и интеллектуальный контур системы — а не изолированный продукт" },
  ...
  { icon: "TrendingUp", text: "Поэтапный переход от прикладных модулей к целостной распределённой модели" },
  { icon: "Building", text: "Прямая связь с операторским контуром АО КСИ как ядром системы" },
];

const WHY_ITEMS = [
  "Снижение концентрации риска и капитала в одной точке девелоперского процесса",
  "Переход от разрозненных действий к управляемой распределённой архитектуре",
  ...
  "Создание базы для интеллектуальной системы распределённого девелопмента",
];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl">
          ...
          <h2 className="font-oswald font-medium text-xl md:text-2xl xl:text-3xl leading-snug mb-8">
            <span className="text-gradient-cyan">Ключевой цифровой и интеллектуальный контур</span><br />
            <span className="text-white/75">интеллектуальной системы распределённого девелопмента</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="font-ibm text-white/50 text-lg leading-relaxed">
              ...
              Это ключевой цифровой и интеллектуальный контур интеллектуальной системы
              распределённого девелопмента, который АО КСИ развивает через внутренние службы,
              прикладные модули и разные модели участия — включая кооперативные механизмы.
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="font-ibm text-white/45 text-lg leading-relaxed">
            ...
            активы, участники, модули и сценарии реализации собираются в интеллектуальную систему
            распределённого девелопмента — с разными моделями реализации, включая кооперативную.
          </p>
        </div>
    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <h2 className="font-oswald text-3xl md:text-4xl font-semibold text-white leading-tight mb-6 text-center">
          ...
          <span className="text-gradient-cyan">в распределённой системе</span>
        </h2>
