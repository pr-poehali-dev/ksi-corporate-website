...
const WHY_ITEMS = [
  ...
  "Создание базы для новой модели распределённого девелопмента",
];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl">
          ...
          <h2 className="font-oswald font-medium text-xl md:text-2xl xl:text-3xl leading-snug mb-8">
            ...
            <span className="text-white/75">кооперативной системы распределённого девелопмента</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="font-ibm text-white/50 text-lg leading-relaxed">
              ...
              Это интеллектуальный и цифровой контур кооперативной системы распределённого
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="font-ibm text-white/45 text-lg leading-relaxed">
            ...
            активы, участники, модули и сценарии реализации могут быть собраны в новую кооперативную
            систему распределённого девелопмента.
          </p>
        </div>
