...
const STRATEGY_POINTS = [
  { icon: "Layers", text: "Движение от прикладных модулей к целостной кооперативной системе" },
  ...
  { icon: "Compass", text: "Формирование новой архитектуры распределённого девелопмента" },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="font-ibm text-white/50 text-lg leading-relaxed mb-6">
              КриптоМетры создаются как цифровой и интеллектуальный контур кооперативной системы,
              способный связывать активы, спрос, участников и сценарии реализации проектов
              в единой управляемой модели распределённого девелопмента.
            </p>
            <p className="font-ibm text-white/35 text-sm leading-relaxed">
              ...
              контуры АО КСИ. Стратегическая цель шире: сформировать кооперативную среду,
              в которой проекты, активы, компетенции и интеллектуальные контуры постепенно
              собираются в новую архитектуру девелопмента.
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-14">
          ...
          <p className="font-ibm text-white/45 text-lg leading-relaxed">
            ...
            и разрозненных каналов спроса. КриптоМетры создаются как кооперативная среда,
