...
const STRATEGY_POINTS = [
  ...
  { icon: "Compass", text: "Формирование интеллектуальной системы кооперативного девелопмента" },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="font-ibm text-white/50 text-lg leading-relaxed mb-6">
              КриптоМетры создаются как цифровой и интеллектуальный контур интеллектуальной
              системы кооперативного девелопмента, способный связывать активы, спрос, участников
