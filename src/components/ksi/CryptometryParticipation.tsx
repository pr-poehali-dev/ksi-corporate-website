        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="font-ibm text-white/48 text-lg leading-relaxed mb-8">
              АО КСИ приглашает девелоперов, владельцев активов, землевладельцев и стратегических
              участников к тестированию, подключению прикладных модулей и участию в практической
              сборке интеллектуальной системы кооперативного девелопмента.
            </p>
          ...
          <div className="space-y-3">
            {[
              { icon: "FlaskConical", text: "Тестирование прикладных модулей кооперативной системы" },
              { icon: "Settings2", text: "Подключение к настройке и обучению интеллектуального контура" },
              { icon: "GitBranch", text: "Проверка сценариев и реальных задач внутри системы" },
              { icon: "ClipboardList", text: "Подготовка активов и проектов в новой логике" },
              { icon: "Rocket", text: "Участие в практической сборке кооперативной модели" },
            ].map((item, i) => (
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10">
        ...
        <p className="font-ibm text-white/48 text-base leading-relaxed mb-5">
          КриптоМетры создаются как попытка собрать в одном цифровом и интеллектуальном контуре
          то, что в классическом девелопменте существует разрозненно: участников, знания, активы,
          решения, исполнение и профессиональную ответственность.
        </p>
        <p className="font-ibm text-white/30 text-sm leading-relaxed">
          Это не обещание мгновенного результата. Это долгосрочная инженерная и кооперативная
          задача — решение которой проходит через практику: через реальные модули, реальных участников
          и поэтапное развитие интеллектуальной системы кооперативного девелопмента.
        </p>
      </div>
    </section>
  );
