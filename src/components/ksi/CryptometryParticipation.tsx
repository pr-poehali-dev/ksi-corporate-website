        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="font-ibm text-white/48 text-lg leading-relaxed mb-8">
              ...
              сборке интеллектуальной системы распределённого девелопмента.
            </p>
          ...
          <div className="space-y-3">
            {[
              { icon: "FlaskConical", text: "Тестирование прикладных модулей системы" },
              ...
              { icon: "Rocket", text: "Участие в практической сборке системы, включая кооперативные механизмы" },
            ].map((item, i) => (
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10">
        ...
        <p className="font-ibm text-white/30 text-sm leading-relaxed">
          ...
          решение которой проходит через практику: через реальные модули, реальных участников
          и поэтапное развитие интеллектуальной системы распределённого девелопмента.
        </p>
      </div>
    </section>
  );
