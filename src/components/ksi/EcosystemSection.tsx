...
const STEPS = [
  { num: "01", label: "Земельный актив", desc: "Поиск, проверка, структуризация через Службу земельного поиска (LSS)" },
  ...
  { num: "04", label: "Система КриптоМетры", desc: "Единая интеллектуальная среда распределённого девелопмента" },
  { num: "05", label: "Реализация через Центр реализации", desc: "Упаковка, подрядчики, контроль экономики проекта" },
  { num: "06", label: "Сопровождение", desc: "Постдевелоперское сопровождение и управление результатом" },
];
