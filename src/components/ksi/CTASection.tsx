    ...
    <section className="py-28 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        <h2 className="font-oswald text-4xl md:text-5xl font-semibold text-white leading-tight mb-6">
          Обсудить подключение модулей<br />
          <span className="text-gradient-main">или архитектуру внедрения</span>
        </h2>
        <p className="font-ibm text-white/45 text-lg leading-relaxed mb-12 max-w-2xl mx-auto">
          АО КСИ открыто к диалогу с девелоперами, владельцами активов и партнёрами,
          которым нужны прикладные ИИ-решения для рынка недвижимости.
        </p>
