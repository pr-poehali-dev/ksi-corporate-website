...
const STAGES = [
  { num: "01", title: "Формирование внутренних служб и прикладных модулей", icon: "Users", status: "active" },
  { num: "02", title: "Решение реальных задач через кооперативный интеллектуальный контур", icon: "Wrench", status: "active" },
  { num: "03", title: "Сборка модулей в единый цифровой и интеллектуальный контур", icon: "Puzzle", status: "next" },
  { num: "04", title: "КриптоМетры как целостный контур интеллектуальной системы кооперативного девелопмента", icon: "Hexagon", status: "planned" },
];
    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-14">
          ...
          <p className="font-ibm text-white/42 text-base max-w-2xl mx-auto">
            КриптоМетры развиваются поэтапно: от прикладных модулей и внутренних служб —
            к целостному цифровому и интеллектуальному контуру кооперативной системы.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="font-ibm text-white/48 text-base leading-relaxed mb-5">
            По мере развития системы внутри КриптоМетров может формироваться собственный
            внутренний контур учёта, доступа и участия, необходимый для работы модулей,
            пользовательских сценариев и кооперативной архитектуры.
          </p>
