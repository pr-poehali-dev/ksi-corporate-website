...
const STAGES = [
  ...
  { num: "02", title: "Решение реальных задач через интеллектуальный контур системы", icon: "Wrench", status: "active" },
  { num: "03", title: "Сборка модулей в единый цифровой и интеллектуальный контур", icon: "Puzzle", status: "next" },
  { num: "04", title: "КриптоМетры как целостный контур интеллектуальной системы распределённого девелопмента", icon: "Hexagon", status: "planned" },
];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-14">
          ...
          <p className="font-ibm text-white/42 text-base max-w-2xl mx-auto">
            ...
            к целостному цифровому и интеллектуальному контуру распределённой системы.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="font-ibm text-white/48 text-base leading-relaxed mb-5">
            ...
            пользовательских сценариев и моделей участия.
          </p>
