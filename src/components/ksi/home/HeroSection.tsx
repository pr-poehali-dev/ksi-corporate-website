    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 text-center" style={{ paddingTop: "18rem", paddingBottom: "10rem" }}>
        ...
        <div style={fade(v2)}>
          ...
          >
            АО КСИ формирует новую архитектуру реализации девелоперских проектов, объединяя активы, спрос, профессиональные роли, прикладные модули и интеллектуальные инструменты в единую управляемую систему.
          </p>
          <p
            className="font-ibm font-medium mx-auto"
            style={{ fontSize: "clamp(14px, 1.4vw, 17px)", color: "rgba(0,212,255,0.55)", maxWidth: 680 }}
          >
            Мы разрабатываем прикладные решения для девелопмента — от цифровых сервисов и аналитических контуров до будущих систем автономного строительства.
          </p>
        </div>
