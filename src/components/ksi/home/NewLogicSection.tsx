...
const CONTRASTS = [
  ...
  {
    icon: "Network",
    label: "Распределённый девелопмент АО КСИ",
    points: [
      "Функции создания и реализации распределены между ролями, контурами и инструментами",
      "Активы, спрос, прикладные модули и ИИ-backend собираются в единую управляемую систему",
      "Вместо замкнутой точки — управляемая система из связанных элементов",
    ],
    tone: "active",
  },
];
    ...
    <section className="relative py-28 sm:py-36" style={{ background: "#080b13" }}>
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        <div className="max-w-3xl mb-16">
          ...
          >
            Что такое<br />распределённый девелопмент
          </h2>
          <p className="font-ibm text-white/45 text-base sm:text-lg leading-relaxed max-w-2xl">
            Проект создаётся не одной компанией, а системой распределённых ролей, участников и инструментов.
            Ключевые функции создания и реализации распределены между профессиональными контурами и модулями,
            а затем собираются в единую управляемую систему. АО КСИ выступает оператором, который связывает
            эти элементы в единую логику.
          </p>
        </div>
        ...
        {/* ИИ как интеллектуальный backend системы */}
        <div
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="font-ibm text-white/70 text-base leading-relaxed">
              ИИ здесь — интеллектуальный backend системы: он принимает и структурирует запросы,
              маршрутизирует задачи, подключает нужные модели и прикладные контуры, собирает
              промежуточные результаты и накапливает знания на реальных задачах.
            </p>
          </div>
        </div>
      </div>
