...
const THESES = [
  ...
  },
  {
    ...
    desc: "Поэтапная сборка прикладных модулей в интеллектуальную систему кооперативного девелопмента.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl mb-14">
          ...
          <p className="font-ibm text-white/50 text-base md:text-lg leading-relaxed">
            ...
            быть собраны в интеллектуальную систему кооперативного девелопмента.
          </p>
        </div>
