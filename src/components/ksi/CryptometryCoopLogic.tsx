...
const THESES = [
  ...
  },
  {
    ...
    desc: "Активы, проекты и сценарии реализации описываются и сопоставляются внутри единой цифровой среды системы.",
  },
  {
    icon: "GitMerge",
    title: "Переход от модулей к целостной системе",
    desc: "Поэтапная сборка прикладных модулей в интеллектуальную систему распределённого девелопмента.",
  },
];
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl mb-14">
          <div className="section-label mb-4">◆ Кооперативная модель</div>
          <h2 className="font-oswald text-4xl md:text-5xl font-semibold text-white leading-tight mb-5">
            Кооперативная модель<br />
            <span className="text-gradient-purple">внутри КриптоМетров</span>
          </h2>
          <p className="font-ibm text-white/50 text-base md:text-lg leading-relaxed">
            Кооперативный девелопмент — одна из моделей реализации внутри КриптоМетров и часть
            более широкой модели распределённого девелопмента. В ней активы, участники, прикладные
            модули, спрос и сценарии реализации собираются вокруг проекта в одной управляемой среде.
          </p>
        </div>
