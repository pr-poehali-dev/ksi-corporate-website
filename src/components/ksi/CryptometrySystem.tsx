...
const START_STEPS = [
  ...
  { num: "02", icon: "Network", title: "Запрос проходит через единый интерфейс", desc: "Все обращения собираются в одну точку входа кооперативного интеллектуального контура.", color: "#7b2fff" },
  { num: "03", icon: "Users", title: "Подключаются внутренние службы и нейронные модели", desc: "Лаборатория ИИ, Центр реализации, Служба земельного поиска и Студия креатива работают совместно с интеллектуальным слоем.", color: "#7b2fff" },
  { num: "04", icon: "CheckCircle", title: "Результат собирается и проверяется", desc: "Прикладной результат собирается, верифицируется и возвращается пользователю — система обучается на каждом реальном запросе.", color: "#00d4ff" },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="font-ibm text-white/50 text-lg leading-relaxed mb-6">
              На стартовом этапе КриптоМетры работают как управляемый интеллектуальный
              и цифровой контур кооперативной системы, в котором живые специалисты,
              нейронные модели и внутренние модули АО КСИ работают вместе.
            </p>
            <div className="p-4 rounded-sm" style={{ background: "rgba(0,212,255,0.02)", borderLeft: "2px solid rgba(0,212,255,0.25)" }}>
              <p className="font-ibm text-white/38 text-sm leading-relaxed">
                Это не отдельный продукт и не автономный ИИ-сервис —
                это управляющий контур внутри кооперативной модели АО КСИ.
              </p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="font-ibm text-white/50 text-lg leading-relaxed mb-6">
              Чат — это не просто удобный бот, а единый вход в кооперативный интеллектуальный
              контур системы. Через него пользователь ставит задачи, получает уточнения,
              отслеживает статус и принимает готовые решения.
            </p>
            <div className="space-y-3">
              {[
                "Один вход для участников, заказчиков и партнёров системы",
                "Маршрутизация задач между модулями и службами на стороне системы",
                "АО КСИ остаётся внутри процесса как оператор кооперативной модели",
              ].map((text, i) => (
          ...
          <div className="rounded-sm overflow-hidden" style={{
            ...
            <div className="px-5 py-3" style={{ borderTop: "1px solid rgba(123,47,255,0.06)", background: "rgba(123,47,255,0.02)" }}>
              <p className="font-ibm text-white/20 text-[11px] text-center">
                Единый вход в кооперативный интеллектуальный контур
              </p>
            </div>
          </div>
        </div>
...
function ContoursBlock() {
  return (
    <section id="contours" className="py-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="section-label mb-4">◆ Внутренние контуры</div>
        <h2 className="font-oswald text-4xl md:text-5xl font-semibold text-white leading-tight mb-4">
          Контуры, формирующие<br /><span className="text-gradient-main">кооперативный механизм</span>
        </h2>
        <p className="font-ibm text-white/42 text-lg leading-relaxed mb-12 max-w-2xl">
          Внутренние службы АО КСИ не просто поддерживают продукт — они формируют прикладную
          архитектуру КриптоМетров, дают системе реальные компетенции и превращают цифровой
          контур в рабочий механизм кооперативной модели.
        </p>
