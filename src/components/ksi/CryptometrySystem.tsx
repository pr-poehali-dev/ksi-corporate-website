...
const START_STEPS = [
  ...
  { num: "02", icon: "Network", title: "Запрос проходит через единый интерфейс", desc: "Все обращения собираются в одну точку входа интеллектуального контура системы.", color: "#7b2fff" },
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="font-ibm text-white/50 text-lg leading-relaxed mb-6">
              ...
              и цифровой контур системы АО КСИ, в котором живые специалисты,
            ...
            <div className="p-4 rounded-sm" style={{ background: "rgba(0,212,255,0.02)", borderLeft: "2px solid rgba(0,212,255,0.25)" }}>
              <p className="font-ibm text-white/38 text-sm leading-relaxed">
                ...
                это интеллектуальный backend внутри системы АО КСИ.
              </p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="font-ibm text-white/50 text-lg leading-relaxed mb-6">
              Чат — это не просто удобный бот, а единый вход в интеллектуальный контур
              системы. Через него пользователь ставит задачи, получает уточнения,
            ...
            <div className="space-y-3">
              {[
                ...
                "АО КСИ остаётся внутри процесса как оператор системы",
              ].map((text, i) => (
          ...
          <div className="rounded-sm overflow-hidden" style={{
            ...
            <div className="px-5 py-3" style={{ borderTop: "1px solid rgba(123,47,255,0.06)", background: "rgba(123,47,255,0.02)" }}>
              <p className="font-ibm text-white/20 text-[11px] text-center">
                Единый вход в интеллектуальный контур системы
              </p>
            </div>
          </div>
        </div>
    ...
    <section id="contours" className="py-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <h2 className="font-oswald text-4xl md:text-5xl font-semibold text-white leading-tight mb-4">
          Контуры, формирующие<br /><span className="text-gradient-main">прикладной механизм системы</span>
        </h2>
        <p className="font-ibm text-white/42 text-lg leading-relaxed mb-12 max-w-2xl">
          ...
          контур в рабочий механизм распределённой модели.
        </p>
