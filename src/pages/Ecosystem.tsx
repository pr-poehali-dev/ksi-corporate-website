...
const LAYERS = [
  { label: "УПРАВЛЯЮЩАЯ КОМПАНИЯ", name: "АО КСИ", desc: "Стратегия, управление, технологическая надстройка", color: "#00d4ff", primary: true },
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="font-ibm text-white/55 text-xl leading-relaxed">
              Единая управляемая структура: управляющая компания, ключевой проект
              и четыре внутренние службы, формирующие контуры виртуального девелопера.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 border-t border-ksi-border/30">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="font-ibm text-white/42 text-base mb-12 max-w-2xl">
            АО КСИ строит систему послойно: от управляющей компании через ключевой проект
            к прикладным контурам внутренних служб.
          </p>
