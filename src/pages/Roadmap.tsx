...
const ROADMAP = [
  {
    ...
    items: [
      ...
      { done: true, text: "Определение замысла: кооперативная система распределённого девелопмента как долгосрочная цель." },
  ...
  },
  {
    ...
    items: [
      ...
      { done: false, text: "Кооперативная система распределённого девелопмента как рабочая модель освоения сложных активов." },
      ...
      { done: false, text: "АО КСИ — оператор кооперативной системы распределённого девелопмента нового поколения." },
    ],
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="font-ibm text-white/55 text-xl leading-relaxed mb-6">
              АО КСИ — оператор кооперативной системы распределённого девелопмента. Дорожная карта
