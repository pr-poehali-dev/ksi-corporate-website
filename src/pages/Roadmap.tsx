...
const ROADMAP = [
  {
    ...
    items: [
      { done: true, text: "Регистрация АО КСИ. Формирование операторской структуры системы." },
      { done: true, text: "Определение замысла: интеллектуальная система распределённого девелопмента как долгосрочная цель." },
  ...
  },
  {
    ...
    phaseCode: "growth",
    items: [
      { done: false, text: "Лаборатория ИИ: развитие интеллектуального backend системы." },
      { done: false, text: "Центр реализации активов: первые пилотные задачи внутри контуров системы." },
      { done: false, text: "КриптоМетры: отработка моделей реализации, включая кооперативную, на реальных запросах участников." },
  ...
  {
    quarter: "2027 — 2028",
    phase: "Сборка распределённой архитектуры",
    phaseCode: "scale",
    items: [
      ...
      { done: false, text: "Лаборатория ИИ: ИИ как интеллектуальный backend над всеми внутренними контурами." },
      { done: false, text: "Запуск интеллектуального чата как единого входа в контур системы." },
      { done: false, text: "Связывание участников, активов, прикладных модулей и сценариев реализации в одной среде." },
    ],
  },
  {
    quarter: "2028+",
    phase: "Целостная распределённая система",
    phaseCode: "maturity",
    items: [
      { done: false, text: "КриптоМетры как целостный интеллектуальный и цифровой контур распределённой системы." },
      { done: false, text: "Интеллектуальная система распределённого девелопмента как рабочая модель освоения сложных активов." },
      { done: false, text: "Запуск разных моделей распределённого девелопмента, включая кооперативные механизмы, на реальных проектах." },
      { done: false, text: "Переход к более автономным системам управления и строительства внутри контуров АО КСИ." },
      { done: false, text: "АО КСИ — оператор интеллектуальной системы распределённого девелопмента нового поколения." },
    ],
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="font-oswald text-5xl md:text-6xl font-bold text-white leading-tight mb-6">
              ...
              <span className="text-gradient-cyan">к распределённой системе</span>
            </h1>
            <p className="font-ibm text-white/55 text-xl leading-relaxed mb-6">
              АО КСИ — оператор интеллектуальной системы распределённого девелопмента. Дорожная карта
              отражает поэтапную сборку прикладных контуров, ИИ-backend и интеллектуального контура
              КриптоМетров в единую распределённую архитектуру.
            </p>
