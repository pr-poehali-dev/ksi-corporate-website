...
const faqs = [
  {
    ...
    a: "Нет. КриптоМетры — это интеллектуальный и цифровой контур кооперативной системы АО КСИ; в рамках работы с участниками внутри системы могут использоваться внутренние расчётные единицы, которые не являются ценными бумагами, финансовыми инструментами, криптовалютой или средством платежа в понимании действующего законодательства РФ.",
  },
  {
    q: "Как оформляется вход в кооперативную систему?",
    a: "Подключение оформляется через договор между АО КСИ и организацией-участником. Договор содержит предмет, порядок расчётов, конфигурацию подключаемых контуров и SLA по задачам.",
  },
  {
  ...
  {
    q: "Как будут развиваться внутренние расчётные единицы системы?",
    a: "Механика применения внутренних расчётных единиц участия внутри кооперативной системы находится в стадии разработки и будет раскрыта участникам отдельно. Уже зафиксированные единицы не аннулируются.",
  },
];
      ...
      <section className="pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <p className="font-ibm text-white/45 text-lg max-w-2xl">
            Всё, что нужно знать юридическому лицу перед входом в кооперативную систему АО КСИ.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="mb-16">
            ...
            <p className="font-ibm text-white/50 text-base leading-relaxed mb-4">
              ...
              с законодательством Российской Федерации. Компания выступает оператором интеллектуальной
              системы кооперативного девелопмента и осуществляет деятельность в сфере технологий
              для девелопмента и управления проектами.
            </p>
          ...
          <div className="mb-16">
            ...
            <p className="font-ibm text-white/45 text-base leading-relaxed mb-4">
              КриптоМетры — это интеллектуальный и цифровой контур кооперативной системы АО КСИ.
              В рамках работы участников внутри системы могут использоваться внутренние расчётные
              единицы, отражающие объём участия юридического лица в кооперативной модели. Начисление
              происходит при выполнении условий участия, зафиксированных в договоре.
            </p>
            <p className="font-ibm text-white/35 text-base leading-relaxed">
              Механика применения внутренних единиц участия находится в разработке.
              Зафиксированные единицы не аннулируются.
            </p>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { icon: "FileSignature", title: "Основной договор", desc: "Регулирует вход в кооперативную систему, конфигурацию контуров, SLA и порядок расчётов." },
                { icon: "Receipt", title: "Закрывающие документы", desc: "Акты, счета-фактуры — в полном объёме по каждому этапу." },
                { icon: "Coins", title: "Условия участия", desc: "Порядок начисления, учёта и применения внутренних единиц участия зафиксирован в договоре." },
