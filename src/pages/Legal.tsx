...
const faqs = [
  {
    ...
    a: "Нет. КриптоМетры — это ключевой цифровой и интеллектуальный контур системы АО КСИ; в рамках работы с участниками внутри системы могут использоваться внутренние расчётные единицы, которые не являются ценными бумагами, финансовыми инструментами, криптовалютой или средством платежа в понимании действующего законодательства РФ.",
  },
  {
    q: "Как оформляется вход в контур АО КСИ?",
  ...
  },
  {
    ...
    a: "Механика применения внутренних расчётных единиц участия внутри системы находится в стадии разработки и будет раскрыта участникам отдельно. Уже зафиксированные единицы не аннулируются.",
  },
];
      ...
      <section className="pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <p className="font-ibm text-white/45 text-lg max-w-2xl">
            Всё, что нужно знать юридическому лицу перед входом в контур АО КСИ.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="mb-16">
            ...
            <p className="font-ibm text-white/45 text-base leading-relaxed mb-4">
              КриптоМетры — это ключевой цифровой и интеллектуальный контур системы АО КСИ.
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { icon: "FileSignature", title: "Основной договор", desc: "Регулирует вход в контур АО КСИ, конфигурацию контуров, SLA и порядок расчётов." },
