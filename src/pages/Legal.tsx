        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="mb-16">
            ...
            <p className="font-ibm text-white/50 text-base leading-relaxed mb-4">
              ...
              с законодательством Российской Федерации. Компания выступает оператором кооперативной
              системы распределённого девелопмента и осуществляет деятельность в сфере технологий
