...
const SERVICES = [
  {
    ...
    desc: "Интеллектуальный backend системы АО КСИ: маршрутизация задач, автоматизация, базы знаний, отраслевые ИИ-решения. Нейронные модели и интеллектуальная логика связывают все элементы системы и встраиваются в КриптоМетры.",
  ...
  },
  {
    ...
    desc: "Прикладной контур системы для работы с активами. Упаковка, капитализация, партнёрское структурирование и вывод активов в продажу, совместное освоение или инвестиционный диалог.",
  ...
  },
  {
    ...
    desc: "Земельный контур системы. Поиск участков, анализ площадок и работа с земельно-имущественными активами под управлением интеллектуального слоя Лаборатории ИИ.",
  ...
  },
  {
    ...
    desc: "Креативный и коммуникационный контур системы. Визуальная и презентационная упаковка проектов и активов — для рынка, переговоров и принятия решений.",
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="font-ibm text-white/55 text-xl leading-relaxed">
              Это не каталог отдельных сервисов, а прикладные контуры системы АО КСИ.
              Лаборатория ИИ — интеллектуальный backend; земельный, операторский и
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="font-ibm text-white/40 text-sm leading-relaxed max-w-xl">
                  Внутренние контуры АО КСИ собираются в КриптоМетры — ключевой цифровой
                  и интеллектуальный контур интеллектуальной системы распределённого девелопмента.
                </p>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="font-ibm text-white/50 text-base leading-relaxed mb-5">
                Каждый контур АО КСИ — не изолированный отдел, а прикладной модуль системы.
                Земельный контур даёт данные и активы, Лаборатория ИИ выступает интеллектуальным
                backend системы, Студия креатива упаковывает результаты, а Центр реализации
              ...
              <p className="font-ibm text-white/32 text-sm leading-relaxed">
                ...
                интеллектуальной системы распределённого девелопмента, в котором задачи решаются
                в единой среде.
              </p>
            </div>
