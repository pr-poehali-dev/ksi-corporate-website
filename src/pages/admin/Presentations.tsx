...
const DEFAULT_CONTENT: Record<string, SectionContent> = {
  hero: {
    ...
    description: "Оператор интеллектуальной инфраструктуры для девелопмента. Управляющая компания проекта «КриптоМетры».",
  },
  about: {
    title: "О компании",
  ...
  roadmap: {
    ...
    phases: [
      { period: "2026", name: "Запуск и формирование контуров", items: ["Регистрация АО КСИ, формирование структуры", "Запуск КриптоМетров как ключевого проекта", "Формирование внутренних служб", "Служба земельного поиска — стадия Beta"] },
      { period: "2026 — 2027", name: "Развитие и пилотные задачи", items: ["Лаборатория ИИ: R&D по интеллектуальной инфраструктуре", "Центр реализации: первые пилотные задачи", "КриптоМетры: отработка гибридной модели", "Приглашение девелоперов к бета-тестированию"] },
      { period: "2027 — 2028", name: "Интеграция в систему", items: ["Интеграция служб в единый интерфейс КриптоМетров", "LSS: переход из Beta в рабочий контур", "Обучение контуров на реальных задачах", "Запуск интеллектуального чата как интерфейса"] },
      { period: "2028+", name: "К виртуальному девелоперу", items: ["КриптоМетры как целостная система", "Все контуры в единой среде с единым интерфейсом", "Система накапливает компетенции с каждым запросом", "АО КСИ — оператор инфраструктуры виртуального девелопера"] },
    ],
  },
  contacts: {
    title: "Контакты",
