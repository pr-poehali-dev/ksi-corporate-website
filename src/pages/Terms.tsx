            ...
            <div className="space-y-8 font-ibm text-white/60 text-sm leading-relaxed">
              ...
              <section>
                ...
                <ul className="list-disc list-inside mt-2 space-y-1">
                  <li>Информация о деятельности АО КСИ как оператора интеллектуальной системы распределённого девелопмента</li>
                  <li>Описание внутренних контуров системы и направлений их работы</li>
