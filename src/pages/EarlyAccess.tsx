      ...
      <section className="pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="font-oswald text-5xl md:text-6xl font-semibold text-white mb-6 leading-tight">
            Ранний вход<br /><span className="text-gradient-main">в контур АО КСИ</span>
          </h1>
          <p className="font-ibm text-white/50 text-lg max-w-2xl mx-auto">
            ...
            или передайте актив — и станьте участником сборки интеллектуальной системы
            ...
            {[
              {
                ...
                desc: "Подключение к земельному, операторскому, креативному и интеллектуальному ИИ-контурам системы.",
              },
              {
                icon: "BrainCircuit",
                title: "Интеллектуальный backend",
                desc: "Интеллектуальный контур Лаборатории ИИ маршрутизирует и сопровождает каждую задачу внутри системы.",
              },
              {
                icon: "Star",
                title: "Статус участника системы",
                desc: "Ранние участники получают приоритет, статус и право голоса в практической сборке системы.",
              },
            ].map((item) => (
