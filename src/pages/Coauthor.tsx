      ...
      <section className="pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="font-ibm text-white/50 text-lg max-w-2xl mx-auto mb-8">
            ...
            интеллектуальной системы кооперативного девелопмента. Те, кто входит в контур сейчас,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="font-ibm text-white/50 text-base leading-relaxed mb-6">
                АО КСИ строит интеллектуальную систему кооперативного девелопмента. Её прикладные
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            {[
              ...
              { icon: "Eye", title: "Прозрачность сборки", desc: "Соавторы видят, как поэтапно собирается интеллектуальная система кооперативного девелопмента." },
