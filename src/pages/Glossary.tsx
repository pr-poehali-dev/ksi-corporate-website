...
const TERMS = [
  {
    term: "АО КСИ",
    category: "Компания",
    definition: "Акционерное общество «КриптоСтройИнвест» — оператор интеллектуальной инфраструктуры для девелопмента. Развивает внутренние службы и прикладные контуры, обеспечивающие создание виртуального девелопера. Ключевой проект — КриптоМетры.",
  },
  {
