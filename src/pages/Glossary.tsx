...
const TERMS = [
  {
    term: "АО КСИ",
    category: "Компания",
    definition: "АО «КриптоСтройИнвест» — управляющая компания, оператор проекта КриптоМетры и четырёх внутренних служб. Строит систему нового типа: виртуального девелопера.",
  },
  {
    term: "Виртуальный девелопер",
    category: "Замысел",
    definition: "Долгосрочная цель АО КСИ — интеллектуальная система, способная выполнять задачи девелопмента через гибридную модель: ИИ + методология + операторская верификация. Не автономный ИИ и не ручной сервис, а управляемая среда, накапливающая компетенции.",
  },
  {
    term: "КриптоМетры",
    category: "Проект",
