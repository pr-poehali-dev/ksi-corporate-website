...
const TERMS = [
  {
    term: "АО КСИ",
    category: "Компания",
    definition: "Акционерное общество «КриптоСтройИнвест» — оператор интеллектуальной системы кооперативного девелопмента. Внутри неё развиваются прикладные контуры, управляющий ИИ-слой и интеллектуальный контур КриптоМетров.",
  },
  {
    term: "Интеллектуальная система кооперативного девелопмента",
    category: "Модель",
  ...
  },
  {
    term: "КриптоМетры",
    category: "Проект",
    definition: "Ключевой проект АО КСИ — интеллектуальный и цифровой контур интеллектуальной системы кооперативного девелопмента. Собирает прикладные модули, внутренние контуры и модели участия в единую среду нового поколения.",
  },
  {
  ...
  },
  {
    term: "PropTech",
    category: "Отрасль",
    definition: "Property Technology — цифровые технологии и программные решения для рынка недвижимости. АО КСИ работает на стыке PropTech и ИИ как оператор интеллектуальной системы кооперативного девелопмента.",
  },
  {
    term: "Редевелопмент",
    category: "Отрасль",
