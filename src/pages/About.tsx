        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <h2 className="font-oswald font-medium text-xl md:text-2xl leading-snug mb-8">
              <span className="text-gradient-main">Оператор кооперативной системы</span>{" "}
            ...
            <p className="font-ibm text-white/50 text-lg leading-relaxed mb-5">
              АО КСИ развивает кооперативную систему нового поколения для работы с активами
              и девелоперскими проектами, объединяя прикладные контуры, внутренние службы,
              ИИ-контур и модели коллективного участия в единую инфраструктуру. Ключевой проект
              компании — КриптоМетры, интеллектуальный и цифровой контур этой системы.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="font-ibm text-white/55 text-lg leading-relaxed mb-5">
                Оператор кооперативной системы распределённого девелопмента.
              ...
              <div className="p-6 rounded-sm" style={{ background: "rgba(255,255,255,0.015)", border: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    "Распределённый девелопмент нового поколения",
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-1">
            {[
              ...
              { level: "Интеллектуальный контур", name: "КриптоМетры", desc: "Интеллектуальный и цифровой контур кооперативной системы распределённого девелопмента", color: "#00d4ff" },
      ...
      <section className="py-20 border-t border-ksi-border/30">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              { icon: "Layers", title: "Кооперативная архитектура", desc: "Каждое решение — часть единой системы. Компания строится как кооперативная архитектура распределённого девелопмента, а не набор проектов.", color: "#00d4ff" },
      ...
      <section className="py-20 border-t border-ksi-border/30"
        ...
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="font-ibm text-white/35 text-base leading-relaxed mb-5">
            АО КСИ создаётся для того, чтобы построить кооперативную систему распределённого
