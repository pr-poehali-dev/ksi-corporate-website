...
const AUDIENCES = [
  {
    icon: "Building2",
    title: "Девелоперам",
    role: "Участие в развитии системы АО КСИ",
    color: "cyan",
    intro: "Девелоперам — вход в контур АО КСИ: подключение к прикладным контурам, доступ к интеллектуальному backend системы и работа с активами в новой логике.",
    details: "Земельный контур даёт данные и площадки, Лаборатория ИИ — интеллектуальный backend, Центр реализации — операторскую поддержку, Студия креатива — упаковку решений. Все контуры работают как единая система внутри КриптоМетров.",
    offers: [
      { icon: "Search", text: "Доступ к земельному контуру и аналитике" },
      { icon: "BrainCircuit", text: "Интеллектуальный ИИ-backend для анализа и due diligence" },
      { icon: "TrendingUp", text: "Операторская поддержка Центра реализации" },
      { icon: "FlaskConical", text: "Участие в развитии КриптоМетров" },
    ],
  ...
  },
  {
    ...
    role: "Ваш актив внутри системы",
    color: "purple",
    intro: "Землевладельцам — структурированные форматы вовлечения участка в систему АО КСИ через земельный контур и интеллектуальный слой КриптоМетров.",
    details: "Земельный контур анализирует участок и формирует цифровое досье, ИИ-контур оценивает потенциал, Центр реализации структурирует сценарий капитализации внутри управляемой среды.",
    offers: [
      ...
      { icon: "ShieldCheck", text: "Сопровождение внутри системы" },
    ],
  ...
  },
  {
    ...
    color: "cyan",
    intro: "Владельцам объектов и портфельных позиций — упаковка, капитализация и вывод актива через прикладной контур системы АО КСИ.",
    details: "Центр реализации формирует сценарий вывода (продажа, совместное освоение, инвестиционный диалог), Студия креатива упаковывает актив, Лаборатория ИИ обеспечивает интеллектуальный аналитический backend.",
    offers: [
  ...
  },
  {
    ...
    role: "Участие в сборке системы АО КСИ",
    color: "purple",
    intro: "Стратегическим партнёрам — участие в практической сборке системы АО КСИ: пилотные сценарии, развитие прикладных контуров и совместная отработка моделей.",
    details: "Это партнёрство не как подряд, а как соучастие в архитектуре новой системы. Доступ к ИИ-контуру, прикладным модулям и логике взаимодействия с участниками.",
    offers: [
      { icon: "GitBranch", text: "Совместная отработка сценариев реализации" },
      { icon: "Network", text: "Доступ к интеллектуальному ИИ-контуру системы" },
      { icon: "Briefcase", text: "Подключение собственных активов и проектов" },
      { icon: "Rocket", text: "Участие в развитии распределённой архитектуры" },
    ],
  ...
  },
  {
    ...
    color: "cyan",
    intro: "АО КСИ приглашает профессиональных участников рынка к тестированию прикладных контуров системы и обучению интеллектуального управляющего слоя на реальных задачах.",
    details: "Подключение к бета-тестированию отдельных модулей, совместная отработка сценариев, участие в настройке моделей реализации — внутри управляемой среды АО КСИ.",
    offers: [
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="font-oswald text-5xl md:text-6xl font-bold text-white leading-tight mb-6">
              Участники<br />
              <span className="text-gradient-purple">системы АО КСИ</span>
            </h1>
            <p className="font-ibm text-white/55 text-xl leading-relaxed">
              АО КСИ — оператор интеллектуальной системы распределённого девелопмента. Это
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center p-12 rounded-sm relative overflow-hidden" style={{ background: "linear-gradient(135deg, rgba(0,212,255,0.04) 0%, rgba(123,47,255,0.04) 100%)", border: "1px solid rgba(0,212,255,0.1)" }}>
            ...
            <p className="font-ibm text-white/45 text-base mb-8 max-w-lg mx-auto">
              ...
              и предложит формат входа в контур АО КСИ.
            </p>
