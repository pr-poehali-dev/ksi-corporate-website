...
const AUDIENCES = [
  {
    ...
    color: "cyan",
    intro: "Девелоперам — вход в кооперативную систему распределённого девелопмента: подключение к прикладным контурам, доступ к управляющему ИИ-слою и работа с активами в новой логике.",
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="font-ibm text-white/55 text-xl leading-relaxed">
              АО КСИ — оператор кооперативной системы распределённого девелопмента. Это
