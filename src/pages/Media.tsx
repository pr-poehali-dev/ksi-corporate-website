...
const ARTICLES = [
  ...
  { cat: "Позиция", date: "Февраль 2024", title: "Интеллектуальная система распределённого девелопмента: новая операционная модель", desc: "Что стоит за термином «интеллектуальная система распределённого девелопмента» и почему это не маркетинговая формула, а описание реальной операционной логики.", readTime: "6 мин", tag: "Модели работы" },
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="font-ibm text-white/55 text-xl leading-relaxed">
              Публичные материалы АО КСИ как оператора интеллектуальной системы распределённого
