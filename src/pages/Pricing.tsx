...
const plans = [
  {
    ...
    features: [
      ...
      "Интеллектуальный ИИ-backend подключается под задачу",
  ...
  },
  {
    ...
    features: [
      ...
      "Земельный, операторский, креативный и интеллектуальный ИИ-контур",
      "Сопровождение оператором системы",
  ...
  },
  {
    ...
    price: "Индивидуально",
    priceNote: "Сборка распределённой модели",
    color: "purple",
    features: [
      ...
      "Совместная отработка сценариев реализации",
      "Индивидуальная договорная конструкция",
      "Доступ к интеллектуальному ИИ-контуру",
    ],
      ...
      <section className="pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="font-ibm text-white/45 text-lg max-w-xl mx-auto">
            ...
            системы АО КСИ. Конфигурация определяется задачей, активом
      ...
      <section className="py-12 border-y border-white/6">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: "Network", title: "Вход в систему, не услуга", desc: "Это не подряд по часовым ставкам, а подключение к контуру системы." },
              { icon: "BrainCircuit", title: "ИИ-контур включён в любую конфигурацию", desc: "Интеллектуальный backend Лаборатории работает с каждой задачей внутри системы." },
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { icon: "BrainCircuit", text: "Интеллектуальный ИИ-контур" },
      ...
      <section className="py-16 border-t border-white/6">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="font-ibm text-white/40 text-sm mb-8">
            ...
            подходящую конфигурацию входа в систему.
          </p>
